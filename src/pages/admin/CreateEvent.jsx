...
import { ArrowLeft, Calendar, MapPin, Image as ImageIcon, DollarSign, Users, Type, IndianRupee } from 'lucide-react';
...
export default function CreateEvent() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            // availableSeats = capacity initially
            const payload = {
                ...data,
                availableSeats: data.capacity,
                date: new Date(data.date).toISOString().slice(0, 19) // Ensure ISO format YYYY-MM-DDTHH:mm:ss for backend
            };
    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white pt-8 pb-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8 flex items-center justify-between">
                    <div>
                        ...
                        <h1 className="text-4xl font-black uppercase tracking-tight">Create New Event</h1>
                    </div>
                </div>

                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {/* Left: Form */}
                    <div className="lg:col-span-2 bg-[#111] p-8 rounded-2xl border border-white/10">
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            {...register('date')}
                                            className="w-full bg-[#050505] border border-white/10 rounded-xl py-3 pl-12 pr-4 text-white focus:outline-none focus:border-[#00E599] "
                                            style={{ colorScheme: 'dark' }} // Force calendar icon dark mode
                                        />
                                    </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-[10px] text-gray-600">Tip: Use Unsplash or similar for quick high-quality images.</p>
                            </div>
